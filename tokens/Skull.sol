...
import "./../dependencies/lib/SafeMath8.sol";
...
contract Skull is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 SKULL-WETH LP -> SKULL pool
    // uint256 public constant INITIAL_SKULL_POOL_DISTRIBUTION = 21600 ether;
    ...
    /**
     * @notice Constructs the SKULL ERC-20 contract.
     */
    ...
    /**
     * @notice Operator mints SKULL to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of SKULL to mint to
