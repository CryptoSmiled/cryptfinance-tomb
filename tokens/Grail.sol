...
contract Grail is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 GRAIL
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 46_000 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 1_500 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4_500 ether;
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("Grail Shares", "GRAIL") {
